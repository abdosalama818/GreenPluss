...
<section class="section">
    ...
    <form action="{{ url('storemedicines') }}" method="post" enctype="multipart/form-data" class="myform">
        @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="col-form-label col-md-12">{{__('Medicine Category')}}</label>
                    <select name="medicine_category_id" class="form-control select2 @error('medicine_category_id') is-invalid @enderror">
  ...
  {{--               <div class="form-group">
                    ...
                    <input type="text" value="{{ old('medicine_category') }}" name="medicine_category" class="form-control @error('medicine_category') is-invalid @enderror">
