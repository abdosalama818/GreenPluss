                        ...
                        <tbody>
                            @foreach ($medicines as $medicine)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset("uploads/$medicine->image") }}" data-fancybox="gallery2">
                                            <img class="avatar-img rounded-circle" alt="User Image" src="{{ asset("uploads/$medicine->image") }}" height="50" width="50">
                                        </a>
                                    </td>
                                    <td>
                                        {{$medicine->name}}
