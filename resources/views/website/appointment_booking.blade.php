        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title">حجز موعد</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="booking-doc-info">
                                <a href="doctor-profile.html" class="booking-doc-img">
                                    <img src="{{ url($doctor['fullImage']) }}" alt="User Image">
                                </a>
                                <div style="padding-right: 10px;" class="booking-info">
                                    <h4><a href="doctor-profile.html">د. {{ $doctor->name }}</a></h4>
                                    <div class="rating">
                                    ...
                                    <p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i>مصر ,الاسكندريه</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-4 col-md-6">
                            <h4 class="mb-1">11 نوفمبر 2023</h4>
                            <p class="text-muted">الاثنين</p>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="day-slot">
                                        <ul>
                                           ...
                                           {{--  @foreach ($today_date as $workHour)
                                            ...
                                            @endforeach --}}
                                             ...
                                             @foreach ($today_date as $date)
                                            <li>
                                                <span>{{  $date->day_index}}</span>
                                                <span class="slot-date">11 Nov <small
                                                        class="slot-year">2023</small></span>
                                            </li>
                        ...
                        <div class="schedule-cont">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="time-slot">
                                        <ul class="clearfix">
                                            @foreach ($doctorlist->WorkingHours as $date)
                                            <li>


                                                <a class="timing" href="#">
                                                    @foreach (json_decode($date['period_list']) as $period_list)
                                                  {{--   {{$period_list->start_time.' - '.$period_list->end_time}} --}}
                                                    <span>start time {{ $period_list->start_time }} </span> <br><span>end time {{ $period_list->end_time }}  </span>
                                                    @endforeach
                    ...
                    <div class="submit-section proceed-btn text-end">
                        <a href="checkout.html" class="btn btn-primary submit-btn">الدفع الان</a>
                    </div>
