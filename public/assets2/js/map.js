...
var locations =[{
	"id":01,
	"doc_name":"د.احمد كارم",
	"speciality":"تخصص جراحه انف واذن وحنجره",
	"address":"الاسكندريه , مصر",
	"next_available":"متاح من الأجد الي الخميس",
	"amount":"جنيه 300 - جنيه 1000",
	"lat":31.2212723,
	"lng":29.9659231,
	"icons":"default",
...
function initialize() {
    ...
    var mapOptions = {
        zoom: 14,
		center: new google.maps.LatLng(31.2212723, 29.9659231),
        scrollwheel: false,
